...
class HAPROServerAutoScaling(MagicDict):
    def __init__(self, vpc, parameters, securitygroup):
        ...
        """
        super(HAPROServerAutoScaling, self).__init__()
        ...
        self.launchConfig = LaunchConfiguration(
            ...
            ImageId=Ref(parameters.HAPROServerImageId),
        ...
        self.AutoscalingGroup = AutoScalingGroup(
            ...
            Tags=[
                {
                    'Key' : 'Name',
                    'Value' : Join("-", [Ref("AWS::StackName"), "ha-pro-autoScaling"]),
