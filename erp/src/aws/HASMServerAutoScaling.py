...
class HASMServerAutoScaling(MagicDict):
    def __init__(self, vpc, parameters, securitygroup):
        ...
        """
        super(HASMServerAutoScaling, self).__init__()
        ...
        self.launchConfig = LaunchConfiguration(
            ...
            ImageId=Ref(parameters.HASMServerImageId),
        ...
        self.AutoscalingGroup = AutoScalingGroup(
            ...
            Tags=[
                {
                    'Key' : 'Name',
                    'Value' : Join("-", [Ref("AWS::StackName"), "ha-sm-autoScaling"]),
